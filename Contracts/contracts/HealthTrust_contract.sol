...
contract HealthTrust {
    ...
    mapping(uint256 => string) public resultRegistry; // orderId => result
    ...
    function completeOrder(uint256 datasetId, uint256 orderId, string memory ipfsHash) external {
        ...
        resultRegistry[orderId] = ipfsHash;
